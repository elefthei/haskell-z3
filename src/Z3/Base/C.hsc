...
foreign import ccall unsafe "Z3_mk_fpa_geq"
    z3_mk_fpa_geq :: Ptr Z3_context
                  -> Ptr Z3_ast -- ^ t1
                  -> Ptr Z3_ast -- ^ t2
                  -> IO (Ptr Z3_ast)

foreign import ccall unsafe "Z3_mk_fpa_gt"
    z3_mk_fpa_gt :: Ptr Z3_context
                 -> Ptr Z3_ast -- ^ t1
                 -> Ptr Z3_ast -- ^ t2
                 -> IO (Ptr Z3_ast)
...
foreign import ccall unsafe "Z3_fpa_get_numeral_sign_bv"
     z3_fpa_get_numeral_sign_bv :: Ptr Z3_context
                                -> Ptr Z3_ast -- ^ fp
                                -> IO (Ptr Z3_ast)
